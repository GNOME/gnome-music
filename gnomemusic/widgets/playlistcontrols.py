...
class PlaylistControls(Gtk.Grid):
    ...
    def playlist_name(self):
        return self._name_label.props.label
    ...
    @log
    def enable_rename_playlist(self, pl_torename, callback_func):
        self.set_name('renaming_dialog')
        self.set_rename_entry_text_and_focus(
            utils.get_media_title(pl_torename))

        self.connect_rename_entry('activate', callback_func)
        self.connect_rename_done_btn('clicked', callback_func)
