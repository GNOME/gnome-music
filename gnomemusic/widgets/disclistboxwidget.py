...
class DiscBox(Gtk.Box):
    ...
    def __init__(self, model=None):
        ...
        self._disc_label.set_no_show_all(True)
        ...
        self.pack_start(self._disc, True, True, 0)
    ...
    def set_disc_number(self, disc_number):
        ...
        """
        self._disc_label.set_label(_("Disc {}").format(disc_number))
        self._disc_label.set_visible(True)
