...
class UserPlaylistWidget(Gtk.Box):
    ...
    def _on_current_playlist_changed(self, parent_view, value):
        """Update view with content from selected playlist"""
        playlist = self._parent_view.props.current_playlist
    ...
    def _play(self, coresong=None):
        ...
        current_playlist = self._parent_view.props.current_playlist
