...
class ArtistArt(GObject.GObject):
    ...
    def __init__(self, coremodel, coreartist):
        super().__init__()
        ...
        coremodel.get_artist_art(self._coreartist)
...
class ArtistCache(GObject.GObject):
    ...
    def __init__(self, size, scale):
        """Initializes ArtistArt.

        :param Art.Size size: The size of the art used for the cover
        :param int scale: Internal scale factor of the widget
        """
        super().__init__()
    ...
    def query(self, coreartist):
        ...
        """
        print("query")
        if coreartist.props.cached_thumbnail_uri == "":
