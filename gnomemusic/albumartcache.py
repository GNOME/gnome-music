...
class Art(GObject.GObject):
    ...
    def _cache_miss(self, klass):
        ...
        embedded_art.connect('not-available', self._embedded_art_not_available)
    ...
    def _embedded_art_not_available(self, klass):
        self._embedded_queue.pop()
...
class EmbeddedArt(GObject.GObject):
    ...
    def _discovered(self, info):
        ...
        # album = utils.get_album_title(self._item)
        # artist = utils.get_artist_name(self._item)
...
class RemoteArt(GObject.GObject):
    ...
    @log
    def _async_delete_callback(self, src, result, data):
        try:
    ...
    @log
    def _async_splice_callback(self,src, result, data):
        ...
        tmp_file.delete_async(
            GLib.PRIORITY_LOW, None, self._async_delete_callback, None)
    ...
    def _read_async_callback(self, src, result, data):
        ...
        ostream.splice_async(
            ...
            None, self._async_splice_callback, [tmp_file, iostream])
