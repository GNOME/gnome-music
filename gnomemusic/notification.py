...
class PopupNotificationManager(Gtk.Revealer):
    ...
    def _set_visibility(self, widget=None):
        """Display or hide Popup Notification Manager.
...
class PlaylistNotification(Gtk.Grid):
    ...
    to the PopupNotificationManager.
    """
    ...
    @log
    def __init__(self, notification_manager, type, message, media_id):
        super().__init__(column_spacing=18)
        ...
        self._timeout_id = GLib.timeout_add_seconds(
            5, self._notification_manager.remove_notification, self,
            'finish-deletion')

        self._notification_manager.add_notification(self)
    ...
    def _undo_clicked(self, widget):
        ...
        self._notification_manager.remove_notification(self, 'undo-deletion')
