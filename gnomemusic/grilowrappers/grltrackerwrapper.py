...
class GrlTrackerWrapper(GObject.GObject):
    ...
    def source(self, new_source):
        ...
        Everytime, the tracker plugin is loaded,
    ...
    def _initial_songs_fill(self, source):
        ...
        options = self._fast_options.copy()
        self.props.source.query(query, self.METADATA_KEYS, options, _add_to_model)
    ...
    def search(self, text):
        ...
        self.props.source.query(query, self.METADATA_KEYS, options, songs_search_cb)
