...
from gnomemusic.notification import PlaylistNotification
...
class PlaylistView(BaseView):
    ...
    @log
    def _get_removal_notification_message(self, type, media_id):
        ...
        if type == PlaylistNotification.Type.PLAYLIST:
    ...
    @log
    def _create_notification(self, type, media_id):
        msg = self._get_removal_notification_message(type, media_id)
        playlist_notification = PlaylistNotification(
            self._window.popup_notification, type, msg, media_id)
    ...
    def _undo_pending_deletion(self, playlist_notification):
        ...
        notification_type = playlist_notification.type
