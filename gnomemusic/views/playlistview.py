...
class PlaylistView(BaseView):
    ...
    @log
    def _on_songs_count_changed(self, klass, arguments):
        self._pl_ctrls.update_songs_count(self.props.songs_count)
