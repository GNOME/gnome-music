...
class Window(Gtk.ApplicationWindow):
    ...
    def _switch_to_empty_view(self):
        ...
        if did_initial_state:
            self.views[View.EMPTY].set_empty_state()
        else:
            self.views[View.EMPTY].set_initial_state()
    ...
    def _switch_to_player_view(self):
        ...
        self.views[View.EMPTY].set_search_state()
    ...
    def _on_notify_mode(self, stack, param):
        ...
        if self.curr_view != self.views[View.SEARCH] and self.curr_view != self.views[View.EMPTY]:
            self.toolbar.searchbar.reveal(False)
