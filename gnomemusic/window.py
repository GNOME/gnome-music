...
from gnomemusic.notification import PopupNotificationManager
...
class Window(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        self._setup_view()
        self.popup_notification = PopupNotificationManager()
        self._overlay.add_overlay(self.popup_notification)
    ...
    def _notify_mode_disconnect(self, data=None):
        self.player.Stop()
        self.popup_notification.terminate_pending()
        self._stack.disconnect(self._on_notify_model_id)
