...
class Window(Gtk.ApplicationWindow):
    ...
    def _switch_to_empty_view(self):
        ...
        if did_initial_state:
            self.views[View.EMPTY].state = EmptyView.State.EMPTY
        else:
            self.views[View.EMPTY].state = EmptyView.State.INITIAL
    ...
    def _switch_to_player_view(self):
        ...
        self.views[View.EMPTY].state = EmptyView.State.SEARCH
        ...
        # empty view has already been created in self._setup_view
        # starting at View.ALBUM
